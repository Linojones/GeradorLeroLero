...
public class Frase {
    ...
    private final String[] parteDois = {
    ...
    private final String[] parteQuatro = {
            ...
            "do processo de comunicaçãoo como um todo.",
            "dos métodos utilizados na avaliaãoo de resultados.",
