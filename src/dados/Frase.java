...
public class Frase {
    ...
    private final String[] parteTres = {
            "nos obriga � an�lise",
            ...
            "afeta positivamente a correta previs�o que",
            "determina o fator de engajamento",
            "pode significar oportunidades",
            "� o touchpoint",
            "habilita o framework de analise",
            "proporciona o empowement",
            "pode ser parte da solu��o",
            "gerencia as expectativas",
            "� urgente e importante",
            "� o game-changer",
            "dever ser uma li��o aprendida"
    };

    private final String[] parteQuatro = {
            ...
            "para a sinergia das a��es planejadas.",
            "na busca da rela��o ganha-ganha.",
            "para sair da zona de conforto.",
            "nas vis�es hol�sticas dos projetos.",
            "em uma organiza��o de classe mundial.",
            "para a determina��o do ROI na organiza��o.",
            "para nos posicionarmos no cutting-edge do segmento.",
            "no universo de consumidores multitela.",
            "nas a��es on e off line.",
